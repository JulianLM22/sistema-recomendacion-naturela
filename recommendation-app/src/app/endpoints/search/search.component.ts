...
export class SearchComponent implements OnInit{
  ...
  buscarPorId = (query: string) => {
    ...
    const servicioUrl: string = 'http://ec2-34-202-165-117.compute-1.amazonaws.com:5000/predict';
    const body = {
  ...
  buscarData = (query: string) => {
    ...
    const servicioUrl: string = 'http://ec2-34-202-165-117.compute-1.amazonaws.com:5000/client';
    const body = {
      user_id: String(this.text)
    };
